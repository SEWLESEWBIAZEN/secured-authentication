...
// import { clientLogin } from "@/app/_services/clientService";
            ...
            <div className="p-8 rounded-2xl bg-white shadow">
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div className="flex items-center">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="h-4 w-4 accent-primary rounded-2xl text-primary focus:ring-cyan-600 border-gray-300"
                    />
                    <label
                      htmlFor="remember-me"
                ...
                <div className="!mt-8">
                  <button
                    // disabled={isPending}
                    className="w-full py-3 px-4 text-sm tracking-wide rounded-xl text-white bg-primary hover:bg-cyan-600 focus:outline-none"
                  >
